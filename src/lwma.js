...
exports.get_diff = function (cumulative_diffs, target_time, solvetimes) {
    ...
    var avg_D = math.chain(cumulative_diffs[size]).subtract(cumulative_diffs[0]).divide(size).done();
    var next_D = 0;
